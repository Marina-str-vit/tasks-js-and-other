/**
 *Задано масив цілих чисел і ціле число , повертає індекси двох чисел такі, що вони в сумі дають target.numstarget

*Ви можете припустити, що кожен вхід матиме рівно один розв'язок, і ви не можете використовувати один і той самий елемент двічі.
